...
$officeNames = [
    '1 - OSDS', '2 - OASDS', '3 - ADMIN', '4 - SGOD CHIEF', '5 - CID CHIEF', '6 - CID', '7 - SGOD',
    '8 - RECORDS', '9 - BAC', '10 - CASH', '11 - BUDGET', '12 - PERSONNEL', '13 - PAYROLL', '14 - SUPPLY', '15 - IT',
    '16 - MEDICAL', '17 - DENTAL'
];
    ...
    <div class="modal-content">
      ...
      <form action="create_account.php" method="post">
         ...
         <select name="office" id="office" required>
             <option value="" disabled selected>Select an Office</option> <?php foreach ($officeNames as $officeOption): ?>
